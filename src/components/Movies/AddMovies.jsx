...
import { addMovie } from '../../api-helper/ap-helpers'
const labelProps={
    mt:1,
    mb:1,
}
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        <Box width={'50%'} padding={10} margin="auto"  marginTop="30" display={"flex"} flexDirection='column' boxShadow={'10px 10px 20px #ccc'}>
