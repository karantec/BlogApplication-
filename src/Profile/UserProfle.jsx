...
import { deleteBooking, getUserBooking, getUserDetails } from '../api-helper/ap-helpers'
...
const UserProfile = () => {
    ...
    useEffect(() => {
        getUserBooking().then((res) => setBooking(res.booking)).catch((err) =>
            console.log(err));
        getUserDetails()
                ...
                {User && (
                    <Box
                        ...
                        <Typography
                            ...
                            textAlign={'center'}
                            border={'1px solid #ccc'}
                            borderRadius={6}>  Name:{user.email}
                        </Typography >
